...
urlpatterns = [
    ...
    # fake urls
    url(r'^api/multicloud-vio/v[01]/vmware_fake/identity/v3',
        FakeToken.as_view()),
    url(r'api/multicloud-vio/v[01]/vmware_fake/identity/v2.0',
        FakeTokenV2.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/identity/projects$',
        FakeProjects.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/identity/projects/'
        r'(?P<projectid>[0-9a-z-A-Z]+)$',
        FakeProjects.as_view()),
    url(r'api/multicloud-vio/v[01]/vmware_fake/identity/tenants',
        FakeTenants.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/nova/'
    ...
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/v2/schemas/image$',
        FakeImageSchema.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/v2/images/'
        r'(?P<imageid>[0-9a-z-A-Z\-\_]+)$',
        FakeImageDetail.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/v2/images',
        FakeImage.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/v2/image/file/'
        r'(?P<imageid>[0-9a-z-A-Z\-\_]+)$',
        FakeImageDownload.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/v2/image/file$',
        FakeImageUpload.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/glance/version',
        FakeImageVersion.as_view()),
    url(r'^api/multicloud-vio/v[01]/vmware_fake/neutron$',
        FakeNeutron.as_view()),
    url(r'api/multicloud-vio/v[01]/vmware_fake/heat/'
        r'(?P<tenantid>[0-9a-z-A-Z\-\_]+)'
