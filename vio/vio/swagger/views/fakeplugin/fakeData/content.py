...
def keystoneVersion(vimid):
    data = {
        "version": {
            ...
            "links": [
                {
                    "href": "http://" + MSB_SERVER + "/api/multivim-vio/v1/fake/"+vimid+"/identity/v3",
                    "rel": "self"
                }
            ]
        }
...
def keystoneToken(teanatid=None,vimid=None):
    ...
    data=  {
        ...
        "catalog":[
            {
                "endpoints":[
                {  "url": "http://"+MSB_SERVER+"/api/multivim-vio/v1/fake/"+vimid+"/cinder/"+TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
...

            {
                "endpoints": [
                {
                    "url": "http://"+MSB_SERVER+"/api/multivim-vio/v1/fake/"+vimid+"/neutron/"+TenatId,
                    "interface": "admin",
                    "region": "nova",
                    "region_id": "nova",
                    "id": "89943db2263e4281b7db8001ce17cdf5"
            ...
            },
            {
                "endpoints": [
                {
                    "url": "http://"+MSB_SERVER+"/api/multivim-vio/v1/fake/"+vimid+"/identity",
                    "interface": "admin",
                    "region": "nova",
                    "region_id": "nova",
                    "id": "89943db2263e4281b7db8001ce17cdf5"},
...

            {
                "endpoints": [
                    {
                        "url": "http://" + MSB_SERVER + "/api/multivim-vio/v1/fake/"+vimid+"/heat/"+TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
                        "id": "89943db2263e4281b7db8001ce17cdf5"},
            ...
            },
            {
                "endpoints": [
                    {
                        "url": "http://" + MSB_SERVER + "/api/multivim-vio/v1/fake/"+vimid+"/nova/"+TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
                        "id": "89943db2263e4281b7db8001ce17cdf5"},
...

            {
                "endpoints": [
                    {
                        "url": "http://" + MSB_SERVER + "/api/multivim-vio/v1/fake/"+vimid+"/glance",
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
                        "id": "89943db2263e4281b7db8001ce17cdf5"},
