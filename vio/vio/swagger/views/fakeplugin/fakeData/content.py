    ...
    data = {
        "token": {
            ...
            },"catalog":[
            {
                "endpoints":[
                {"url": "http://"+MSB_SERVER +
                        "/api/multicloud-vio/v0/vmware_fake/cinder/" + TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
...

            {
                ...
                {
                    "url": "http://"+MSB_SERVER+
                           "/api/multicloud-vio/v0/vmware_fake/neutron/"+TenatId,
                    "interface": "admin",
                    "region": "nova",
                    "region_id": "nova",
                    "id": "89943db2263e4281b7db8001ce17cdf5"
...

            {
                "endpoints": [
                    {
                        "url": "http://" + MSB_SERVER +
                               "/api/multicloud-vio/v0/vmware_fake/heat/"+TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
                        "id": "89943db2263e4281b7db8001ce17cdf5"},
            ...
            },
            {
                "endpoints": [
                    {
                        "url": "http://" + MSB_SERVER +
                               "/api/multicloud-vio/v0/vmware_fake/nova/"+TenatId,
                        "interface": "admin",
                        "region": "nova",
                        "region_id": "nova",
                        "id": "89943db2263e4281b7db8001ce17cdf5"},
            ...
            return {
                "error": {
                    "message": "Cannot 'suspend' instance {0} while "
                               "it is in vm_state {1}".format(serverid,
                                        serverMapps[serverid]['status']),
                    "code": 409
                }
            }
...
def createInstance(token, minCount=1, maxCount=2, json=None):
    ...
    serverMapps[uid] = {"name":name,"tenantid":TenatId,"status":"BUILDING",
