...
class FakeProjects(APIView):
    ...
    def get(self,request,vimid,projectid=None):
    ...
    def patch(self,request,vimid,projectid):
        return  Response()

    def post(self,request,vimid):
        return Response()

    def delete(self,request,vimid,projectid):
        return Response()
...
class FakeToken(APIView):
    ...
    def get(self,request,vimid):
        ...
        return Response(data=keystoneVersion(vimid=vimid),status=status.HTTP_200_OK)
    ...
    def post(self,request,vimid):
        ...
        tokeninfo = keystoneToken(teanatid=tennatid,vimid=vimid)
