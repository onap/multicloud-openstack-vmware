...
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import get_oshypervisor
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import get_servers
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import show_serverDetail
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import operator_server
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import delete_server
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import create_instance
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import get_serverdetail
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import get_osaggregates
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import hypervisor_uptime
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import get_flavors
from vio.swagger.views.fakeplugin.fakeData.fakeRespone import list_flavors
