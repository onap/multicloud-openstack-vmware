...
class BaseClient(APIView):
    ...
    def buildRequest(self,request,vimid,tenantid="",tail=None):
        ...
        preUrl = catalog.getEndpointBy(vimid, serverType=self.serverType,interface="admin")
        token = request.META.get('HTTP_X_AUTH_TOKEN', "")
        tail = "/" + tail if tail and tail != "" else ""
        tenantid = "/" + tenantid if tenantid and tenantid  != "" else ""
